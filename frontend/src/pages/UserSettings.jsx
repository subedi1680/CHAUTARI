          ...
          <>
            ...
            <div className="card p-4 shadow-sm" style={{ maxWidth: '600px' }}>
              ...
              <div className="text-center">
                <img src={avatar} alt="Avatar" className="rounded-circle mb-2" style={{ width: '80px', height: '80px' }} />
                <br />
                <label className="btn btn-dark btn-sm">
                  Change Avatar
                  <input type="file" accept="image/*" className="d-none" onChange={handleAvatarChange} />
                </label>
                <p className="text-muted small mt-1">Recommended: Square image, at least 400x400px</p>
              </div>
